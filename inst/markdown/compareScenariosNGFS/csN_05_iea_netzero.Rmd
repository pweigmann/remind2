...
## GDP
```{r}
plot_default(ivar="GDP|MER", ititle="GDP|MER in 2030 [billion US$2010/yr]", fname="GDP_MER_2030", iper=2030)
...
plot_default(ivar="Emissions|Kyoto Gases", ititle="Emissions of Kyoto Gases in 2050 [GtCO2eq/yr]", 
             fname="emi_kyoto_2030", irange = c(15000, 40000), iper=2030)
plot_default(ivar="Emissions|Kyoto Gases", ititle="Emissions of Kyoto Gases in 2050 [GtCO2eq/yr]", 
             fname="emi_kyoto_2050", irange = c(0, 18000))
```
...
plot_default(ivar="Emissions|CO2", ititle="CO2 Emissions in 2030 [GtCO2/yr]", 
             fname="emi_co2_2030", irange = c(10000, 30000), iper=2030)
plot_default(ivar="Emissions|CO2", ititle="CO2 Emissions in 2050 [GtCO2/yr]", 
             fname="emi_co2_2050", irange = c(-3000, 9000))
```
...
plot_default(ivar="Emissions|CO2|Energy|Demand|Residential and Commercial", ititle="CO2 Emissions from Buildings in 2030 [GtCO2/yr]", 
             fname="emi_co2_build_2030", iper=2030)
...
plot(p7)
ggsave(paste0("plot_CDR_Aff_BECCS_",tmstmp,".png"), p7 + theme(legend.position = "none"), width = 8, height = 8)
...
print(p1)
ggsave(paste0("0_plot_Elec_Share_Solar_Wind_",tmstmp,"_2030_withLegend.png"), p1, width = 8, height = 8)
...
p1 <- plot_comparison_sr15_ngfs_iea(tmp_sr15, tmp_ngfs, tmp_iea, tmp_ar6, tmp_title)
print(p1)
ggsave(paste0("0_plot_Elec_Share_Solar_Wind_",tmstmp,"_withLegend.png"), p1, width = 8, height = 8)
