# IEA Net-Zero Comparison with NGFS Phase 3{-}

# Socio-Economics

## GDP
```{r}
plot_default(ivar="GDP|MER", ititle="GDP|MER in 2030 [billion US$2010/yr]", phase = 3, fname="GDP_MER_2030", iper=2030,irange=c(80000, 120000))
plot_default(ivar="GDP|MER", ititle="GDP|MER in 2050 [billion US$2010/yr]", phase = 3, fname="GDP_MER_2050")
plot_default(ivar="GDP|PPP", ititle="GDP|PPP in 2030 [billion US$2010/yr]", phase = 3, fname="GDP_PPP_2030", iper=2030, irange=c(120000, 180000))
plot_default(ivar="GDP|PPP", ititle="GDP|PPP in 2050 [billion US$2010/yr]", phase = 3, fname="GDP_PPP_2050", irange=c(200000, 300000))
```

## Population
```{r}
plot_default(ivar="Population", ititle="Population in 2030 [million]", phase = 3, fname="pop_2030", irange=c(8000, 8500), iper=2030)
plot_default(ivar="Population", ititle="Population in 2050 [million]", phase = 3, fname="pop_2050", irange=c(9000, 9500))
```


## Carbon Price
```{r}
plot_default(ivar="Price|Carbon", ititle="Carbon Price in 2030 [US$2010/t CO2]", phase = 3, fname="carbon_price_2030", irange=c(0, 1000), iper=2030)
plot_default(ivar="Price|Carbon", ititle="Carbon Price in 2050 [US$2010/t CO2]", phase = 3, fname="carbon_price_2050", irange=c(0, 2000))
```
...
plot_default(ivar="Emissions|Kyoto Gases", ititle="Emissions of Kyoto Gases in 2050 [GtCO2eq/yr]", 
             phase = 3, fname="emi_kyoto_2030", irange = c(15, 45), iper=2030, ifac=0.001)
plot_default(ivar="Emissions|Kyoto Gases", ititle="Emissions of Kyoto Gases in 2050 [GtCO2eq/yr]", 
             phase = 3, fname="emi_kyoto_2050", irange = c(0, 18), ifac=0.001)
```
...
plot_default(ivar="Emissions|CO2", ititle="CO2 Emissions in 2030 [GtCO2/yr]", 
             phase = 3, fname="emi_co2_2030", irange = c(10, 30), iper=2030, ifac=0.001)
plot_default(ivar="Emissions|CO2", ititle="CO2 Emissions in 2050 [GtCO2/yr]", 
             phase = 3, fname="emi_co2_2050", irange = c(-3, 9), ifac=0.001)
```
...
plot_default(ivar="Emissions|CO2|Energy", ititle="CO2 Energy Emissions in 2030 [GtCO2/yr]", 
             phase = 3, fname="emi_co2_energy_2030", iper=2030, ifac=0.001)
plot_default(ivar="Emissions|CO2|Energy", ititle="CO2 Energy Emissions in 2050 [GtCO2/yr]", 
             phase = 3, fname="emi_co2_energy_2050", ifac=0.001)
```
...
plot_default(ivar="Emissions|CO2|Energy|Demand|Residential and Commercial", ititle="CO2 Emissions from Buildings in 2030 [GtCO2/yr]", 
             phase = 3, fname="emi_co2_build_2030", iper=2030, ifac=0.001)
plot_default(ivar="Emissions|CO2|Energy|Demand|Residential and Commercial", ititle="CO2 Emissions from Buildings in 2050 [GtCO2/yr]", 
             phase = 3, fname="emi_co2_build_2050", ifac=0.001)
```
...
plot_default(ivar="Carbon Sequestration|CCS", ititle="CCS in 2030 [GtCO2/yr]", 
             phase = 3, fname="CCS_2030", ifac=1e-3, iper=2030, irange = c(0, 6))
...
plot(p7)
ggsave(paste0("plot_CDR_Aff_BECCS_2030_p3_",tmstmp,".png"), p7 + theme(legend.position = "none"), width = 10, height = 10)
...
p7 <- plot_comparison_sr15_ngfs_iea(tmp_sr15, tmp_ngfs, tmp_iea, tmp_ar6, tmp_title)
plot(p7)
ggsave(paste0("plot_CDR_Aff_BECCS_2050_p3_",tmstmp,".png"), p7 + theme(legend.position = "none"), width = 10, height = 10)
```
...
plot_default(ivar="Primary Energy|Fossil", ititle="Total Fossils Use in 2030 [EJ/yr]", 
             phase = 3, fname="PE_fossil_2030", iper = 2030)
plot_default(ivar="Primary Energy|Fossil", ititle="Total Fossils Use in 2050 [EJ/yr]", 
             phase = 3, fname="PE_fossil_2050")
```

### Coal {-}
```{r}
plot_default(ivar="Primary Energy|Coal", ititle="Coal Use in 2030 [EJ/yr]", phase = 3, fname="PE_coal_2030", iper=2030)
plot_default(ivar="Primary Energy|Coal", ititle="Coal Use in 2050 [EJ/yr]", phase = 3, fname="PE_coal_2050")
```

### Oil {-}
```{r}
plot_default(ivar="Primary Energy|Oil", ititle="Oil Use in 2030 [EJ/yr]", phase = 3, fname="PE_oil_2030", iper=2030)
plot_default(ivar="Primary Energy|Oil", ititle="Oil Use in 2050 [EJ/yr]", phase = 3, fname="PE_oil_2050")
```

### Gas {-}
```{r}
plot_default(ivar="Primary Energy|Gas", ititle="Gas Use in 2030 [EJ/yr]", phase = 3, fname="PE_gas_2030", iper=2030)
plot_default(ivar="Primary Energy|Gas", ititle="Gas Use in 2050 [EJ/yr]", phase = 3, fname="PE_gas_2050")
```

### Biomass {-}
```{r}
plot_default(ivar="Primary Energy|Biomass", ititle="Primary Bioenergy in 2030 [EJ/yr]", 
             phase = 3, fname="PE_biomass_2030", irange=c(50, 150), iper=2030)
plot_default(ivar="Primary Energy|Biomass", ititle="Primary Bioenergy in 2050 [EJ/yr]", 
             phase = 3, fname="PE_biomass_2050", irange=c(50, 250))
```

### Non-Biomass Renewables {-}
```{r}
plot_default(ivar="Primary Energy|Non-Biomass Renewables", ititle="Primary Energy Non-Biomass Renewables in 2030 [EJ/yr]", 
             phase = 3, fname="PE_non_biomass_2030", irange=c(0, 150), iper=2030)
plot_default(ivar="Primary Energy|Non-Biomass Renewables", ititle="Primary Energy Non-Biomass Renewables in 2050 [EJ/yr]", 
             phase = 3, fname="PE_non_biomass_2050", irange=c(0, 400))
```

### Nuclear {-}
```{r}
plot_default(ivar="Primary Energy|Nuclear", ititle="Primary Energy Nuclear in 2030 [EJ/yr]", 
             phase = 3, fname="PE_nuclear_2030", irange=c(0, 35), iper=2030)
plot_default(ivar="Primary Energy|Nuclear", ititle="Primary Energy Nuclear in 2050 [EJ/yr]", 
             phase = 3, fname="PE_nuclear_2050", irange=c(0, 60))
```

## Final Energy
```{r}
plot_default(ivar="Final Energy",ititle="Final Energy Use in 2030 [EJ/yr]", phase = 3, fname="FE_2030", irange=c(250,500), iper=2030, histvar = "FE")
p<-plot_default(ivar="Final Energy",ititle="Final Energy Use in 2050 [EJ/yr]", phase = 3, fname="FE_2050", irange=c(250,500)) + geom_hline(yintercept=430, linetype=2) + annotate("text", x=2050, y=430, label="2019", vjust = -0.5)
```

### Hydrogen {-}
```{r}
plot_default(ivar="Final Energy|Hydrogen",ititle="Hydrogen Use in 2030 [EJ/yr]", phase = 3, fname="FE_hydrogen_2030", iper=2030)
plot_default(ivar="Final Energy|Hydrogen",ititle="Hydrogen Use in 2050 [EJ/yr]", phase = 3, fname="FE_hydrogen_2050")
```
