...
# change ordering of factors, put last element first
...
More detailed results, Standalone Test
...
p <- ggplot(data, aes(X, Y, fill= cols, text=text)) +
  ...
  scale_x_discrete(expand=c(0, 0), breaks=c("I", "J"))+
